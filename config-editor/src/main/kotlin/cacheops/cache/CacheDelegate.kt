...
class CacheDelegate(directory: String) : Cache {
    ...
    override fun generateOldVersionTable(): ByteArray = delegate.generateUkeys()

    override fun generateNewVersionTable(exponent: BigInteger, modulus: BigInteger) = delegate.generateUkeys(false, exponent, modulus)
