...
/**
 * Represents the dialogue file for Duke Horacio in the Dragon Slayer quest.
 *
  * # Relations
 * - [DragonSlayer]
 */
class DukeDragonSlayerDialogue(val questStage: Int) : DialogueFile() {
    ...
    private fun hasShield(player: Player): Boolean = player.inventory.containsItem(DragonSlayer.SHIELD) || player.bank.containsItem(DragonSlayer.SHIELD) || player.equipment.containsItem(DragonSlayer.SHIELD)
}
