                ...
                when (stage) {
                    ...
                    33 -> {
                        ...
                        val advanceStage: (() -> Unit) = {
                            npc!!.isWalks = true
                            setAttribute(player!!,
                                content.region.asgarnia.burthope.quest.death.dialogue.HaroldDialogueFile.Companion.ATTRIBUTE_JUMPSTAGE, stage + 1)
                            openDialogue(player!!,
                                content.region.asgarnia.burthope.quest.death.dialogue.HaroldDialogueFile(), npc!!)
                        }
                    ...
                    34 -> {
                        ...
                        val haroldAmount = getAttribute(player!!,
                            content.region.asgarnia.burthope.quest.death.dialogue.HaroldDialogueFile.Companion.ATTRIBUTE_HAROLD_MONEY, 0)
                        if (getAttribute(player!!, "deathplateau:winstate", false)) {
                            if (wager > haroldAmount) {
                                ...
                                setAttribute(player!!,
                                    content.region.asgarnia.burthope.quest.death.dialogue.HaroldDialogueFile.Companion.ATTRIBUTE_HAROLD_MONEY, haroldAmount - wager)
                                sendItemDialogue(
                                    player!!,
                                    Items.COINS_6964,
            ...
            14 -> {
                when (stage) {
                    ...
                    24 -> {
                        ...
                        val advanceStage: (() -> Unit) = {
                            setAttribute(player!!,
                                content.region.asgarnia.burthope.quest.death.dialogue.HaroldDialogueFile.Companion.ATTRIBUTE_JUMPSTAGE, stage + (1..4).random())
                            openDialogue(player!!,
                                content.region.asgarnia.burthope.quest.death.dialogue.HaroldDialogueFile(), npc!!)
                        }
                        setAttribute(player!!, "deathplateau:dicegameclose", advanceStage)
