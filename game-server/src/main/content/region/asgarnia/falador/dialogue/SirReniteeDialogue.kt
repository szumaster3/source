...
class SirReniteeDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            100 -> npc(FaceAnim.HALF_GUILTY, "Hmm, well, mmm, do you have a family crest? I keep", "track of every " + ServerConstants.SERVER_NAME + " family, you know, so I might", "be able to find yours.").also { stage = 110 }
            ...
            250 -> when (buttonId) {
                1 -> player(FaceAnim.HALF_GUILTY, "I don't like that crest. Can I have a different one?").also { stage = 300 }
            ...
            330 -> when (buttonId) {
                ...
                2 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npc(FaceAnim.HALF_GUILTY, "You do not seem to be very devoted to any god.", "I will not let you have a divine symbol", "unless you have level 70 prayer.").also {
                            stage = 310
                        }
                    }
                }
            ...
            350 -> when (buttonId) {
                1 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        if (!player.achievementDiaryManager.getDiary(DiaryType.FALADOR)!!.isComplete(2, 1)) {
                            player.achievementDiaryManager.getDiary(
                                DiaryType.FALADOR,
                ...
                2 -> {
                    ...
                    if (c.eligible(player) && amountInInventory(player, Items.COINS_995) > c.cost && removeItem(player, Item(Items.COINS_995, c.cost))) {
                        ...
                        npc(FaceAnim.HALF_GUILTY, "A symbol of death? You do not seem like a killer to me;", "perhaps some other symbol would suit you better.").also {
                            stage = 310
                        }
                    }
                }
            ...
            504 -> when (buttonId) {
                1 -> if (!hasRequirement(player, Quests.HOLY_GRAIL, false)) {
                ...
                2 -> if (!isQuestComplete(player, Quests.PLAGUE_CITY)) {
                ...
                3 -> if (!hasRequirement(player, Quests.THE_GIANT_DWARF, false)) {
                ...
                4 -> if (!hasRequirement(player, Quests.THRONE_OF_MISCELLANIA, false)) {
            ...
            515 -> when (buttonId) {
                ...
                3 -> {
                    if (!isQuestComplete(player, Quests.CREATURE_OF_FENKENSTRAIN) || !hasRequirement(player, Quests.SHADES_OF_MORTTON, false) || !hasRequirement(player, Quests.GHOSTS_AHOY, false) || !hasRequirement(player, Quests.HAUNTED_MINE, false)) {
