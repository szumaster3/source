...
class ShelfPlugin : InteractionListener {
    ...
    companion object {
        ...
        private fun getTeapot(id: Int): Int = when (id) {
            Scenery.SHELVES_13550, Scenery.SHELVES_13551 -> Items.TEAPOT_7726
            Scenery.SHELVES_13549, Scenery.SHELVES_13547 -> Items.TEAPOT_7714
            else -> Items.TEAPOT_7702
        }

        private fun getPorcelainCup(id: Int): Int = when (id) {
            Scenery.SHELVES_13550, Scenery.SHELVES_13551 -> Items.PORCELAIN_CUP_7735
            Scenery.SHELVES_13549, Scenery.SHELVES_13548, Scenery.SHELVES_13547 -> Items.PORCELAIN_CUP_7732
