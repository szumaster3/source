...
enum class GodSpellDefinition(
    ...
    GUTHIX(
        ...
        endGraphics = Graphics(Graphic.CLAWS_OF_GUTHIX_77),
        projectile = null,
    ...
    ZAMORAK(
        ...
        endGraphics = Graphics(Graphic.FLAMES_OF_ZAMORAK_78),
        projectile = null,
