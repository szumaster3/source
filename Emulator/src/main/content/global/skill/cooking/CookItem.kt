...
enum class CookItem(
    ...
    companion object {
        /**
         * Maps raw item ids to [CookItem] definitions.
         */
        val cookingMap: HashMap<Int, CookItem> = HashMap()

        /**
         * Maps cooked item ids to their [CookItem] definitions
         * for intentional burn handling.
         */
        val intentionalBurnMap: HashMap<Int, CookItem?> = HashMap()

        /**
         * Bonus values applied when using cooking gauntlets.
         * The value is an [IntArray] of [successRate, levelRequirement].
         */
        val gauntletValues: HashMap<Int, IntArray> = HashMap()

        /**
         * Bonus values for using the Lumbridge range.
         * The value is an [IntArray] of [successRate, levelRequirement].
         */
        ...
        /**
         * Retrieves a [CookItem] by its raw item id.
         *
         * @param id The raw item id.
         * @return The corresponding [CookItem], or null if not found.
         */
        @JvmStatic
        fun forId(id: Int): CookItem? {
            return cookingMap[id]
        }

        /**
         * Gets the burnt version of the item.
         *
         * @param id The raw item id.
         * @return The burnt [Item] version.
         */
        ...
        /**
         * Checks if the given item id corresponds to a
         * [CookItem] that can be intentionally burnt.
         *
         * @param id The cooked item id.
         * @return `true` if it can be intentionally burnt, `false` otherwise.
         */
        ...
        /**
         * Gets the intentionally burnt version of a cooked item.
         *
         * @param id The cooked item id.
         * @return The burnt [Item] version.
         */
