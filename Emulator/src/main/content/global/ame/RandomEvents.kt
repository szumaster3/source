...
enum class RandomEvents(
    ...
    // PILLORY(npc = PilloryNPC(), skillIds = intArrayOf(Skills.THIEVING, Skills.ATTACK, Skills.ATTACK, Skills.STRENGTH, Skills.DEFENCE, Skills.RANGE, Skills.PRAYER), loot = CERTER.loot,),
    MAZE(npc = MazeNPC()),
    QUIZ_MASTER(
        npc = QuizMasterNPC(),
        skillIds =
