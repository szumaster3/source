...
class FieldPickingOptionHandler : OptionHandler() {
    ...
    private enum class PickingPlant(
        ...
        RED_FLOWERS(objectId = Scenery.RED_FLOWERS_15846, reward = Items.RED_FLOWERS_8938, respawn = 1),
        BLUE_FLOWERS(objectId = Scenery.BLUE_FLOWERS_15872, reward = Items.BLUE_FLOWERS_8936, respawn = 1),
