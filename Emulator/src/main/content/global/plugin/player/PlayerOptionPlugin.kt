...
class PlayerOptionPlugin : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(IntType.PLAYER, Option.Companion._P_ATTACK.name) { player, node ->
            player.attack(node)
            return@on true
        }
        ...
        on(IntType.PLAYER, Option.Companion._P_TRADE.name) { player, node ->
        ...
        on(IntType.PLAYER, Option.Companion._P_ASSIST.name) { player, node ->
        ...
        on(IntType.PLAYER, Option.Companion._P_FOLLOW.name) { player, node ->
