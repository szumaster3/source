                ...
                1 -> {
                    ...
                    when (randomDialogue) {
                        0 -> when (stage) {
                            ...
                            2 -> playerl(FaceAnim.FRIENDLY, "Oooh, I love jokes! Go on then!").also { stage++ }
                            ...
                            8 -> playerl(FaceAnim.FRIENDLY, "Haha, good one!").also { stage = END_DIALOGUE }
                        }
                        1 -> when (stage) {
                            0 -> playerl(FaceAnim.FRIENDLY, "Hey there, rock! How are you settling into your new home?").also { stage++ }
                            1 -> sendItemDialogue(player!!, Items.PET_ROCK_3695, "...").also { stage++ }
                            2 -> playerl(FaceAnim.FRIENDLY, "I'm Glad to hear it!").also { stage++ }
                            3 -> playerl(FaceAnim.FRIENDLY, "Erm, this is kind of awkward, but... one of the neighbours found a pile of pebbles on their lawn.").also { stage++ }
                            4 -> playerl(FaceAnim.FRIENDLY, "Now, I'm not saying it WAS you...").also { stage++ }
                            5 -> sendItemDialogue(player!!, Items.PET_ROCK_3695, "...").also { stage++ }
                            6 -> playerl(FaceAnim.FRIENDLY, "Alright, alright, I believe you! There's no need for that kind of language!").also { stage = END_DIALOGUE }
                        }
                        2 -> when (stage) {
                            0 -> playerl(FaceAnim.FRIENDLY, "Hello there, rock. How are things?").also { stage++ }
                            1 -> sendItemDialogue(player!!, Items.PET_ROCK_3695, "...").also { stage++ }
                            2 -> playerl(FaceAnim.FRIENDLY, "Hmmm, I don't know. Have you tried swamp tar? I hear that's good at clearing rashes.").also { stage++ }
                            3 -> npc("...").also { stage = END_DIALOGUE }
                        }
                        3 -> when (stage) {
                            0 -> playerl(FaceAnim.FRIENDLY, "Hello there, rock. How are things?").also { stage++ }
                            1 -> sendItemDialogue(player!!, Items.PET_ROCK_3695, "...").also { stage++ }
                            2 -> playerl(FaceAnim.FRIENDLY, "Oh, what a lovely song! That was a nice surprise, rock!").also { stage = END_DIALOGUE }
                        }
                        4 -> when (stage) {
                            0 -> playerl(FaceAnim.FRIENDLY, "Hey there, rock! How are you settling into your new home?").also { stage++ }
                            1 -> sendItemDialogue(player!!, Items.PET_ROCK_3695, "...").also { stage++ }
                            2 -> playerl(FaceAnim.FRIENDLY, "Oh, I'm sorry to hear that.").also { stage++ }
                            3 -> sendItemDialogue(player!!, Items.PET_ROCK_3695, "...").also { stage++ }
                            4 -> playerl(FaceAnim.FRIENDLY, "I'll be sure to complain to the housing association on your behalf, and petition for them to be moved out of the neighbourhood!").also { stage = END_DIALOGUE }
                        }
                        5 -> when (stage) {
                            0 -> playerl(FaceAnim.FRIENDLY, "Good day, rock!").also { stage++ }
                            1 -> sendItemDialogue(player!!, Items.PET_ROCK_3695, "...").also { stage++ }
                            2 -> playerl(FaceAnim.FRIENDLY, "Oooh, I love jokes! Go on then!").also { stage++ }
                            3 -> sendItemDialogue(player!!, Items.PET_ROCK_3695, "...").also { stage++ }
                            4 -> playerl(FaceAnim.FRIENDLY, "I don't know, what is the difference between a cow and a goblin?").also { stage++ }
                            5 -> sendItemDialogue(player!!, Items.PET_ROCK_3695, "...").also { stage++ }
                            6 -> playerl(FaceAnim.FRIENDLY, "Rock! How could you! That's awful!").also { stage++ }
                            7 -> sendItemDialogue(player!!, Items.PET_ROCK_3695, "...").also { stage++ }
                            8 -> playerl(FaceAnim.FRIENDLY, "I don't care if the other rocks think it's funny, you're not to talk like that again!").also { stage = END_DIALOGUE }
                        }
                    }
                }
                2 -> {
