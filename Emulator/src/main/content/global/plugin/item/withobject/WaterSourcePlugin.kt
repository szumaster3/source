...
class WaterSourcePlugin : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        /*
         * https://gitlab.com/2009scape/2009scape/-/blob/master/Server/src/main/content/global/handlers/item/withobject/WaterSourceListener.kt
         */
    ...
    internal enum class WaterVessel(
        ...
        companion object {
            ...
            /**
             * Gets all valid input item ids.
             */
            fun getInputs(): IntArray = itemMap.keys.toIntArray()

            /**
             * Gets the WaterVessel for a given item id.
             */
