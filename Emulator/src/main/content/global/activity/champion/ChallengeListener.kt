...
class ChallengeListener : InteractionListener, MapArea {
    ...
    override fun getRestrictions(): Array<ZoneRestriction> = arrayOf(ZoneRestriction.CANNON, ZoneRestriction.FIRES, ZoneRestriction.RANDOM_EVENTS)
    ...
    private fun displayScroll(player: Player, item: Item) {
        val content = when (item.id) {
            Items.CHAMPION_SCROLL_6798 -> arrayOf("I challenge you to a duel, come to the arena", "beneath the Champion's Guild and fight me if you", "dare.", "", "Champion of Earth Warriors")
            Items.CHAMPION_SCROLL_6799 -> arrayOf("Come and duel me at the Champions' Guild, I'll", "make sure nothing goes to waste.", "", "Champion of Ghouls")
            Items.CHAMPION_SCROLL_6800 -> arrayOf("Get yourself to the Champions' Guild, if you dare", "to face me puny human.", "", "Champion of Giants")
            Items.CHAMPION_SCROLL_6801 -> arrayOf("Fight me if you think you can human, I'll wait", "for you in the Champion's Guild.", "", "Champion of Goblins")
            Items.CHAMPION_SCROLL_6802 -> arrayOf("You won't defeat me, though you're welcome to", "try at the Champions' Guild.", "", "Champion of Hobgoblins")
            Items.CHAMPION_SCROLL_6803 -> arrayOf("How about picking on someone your own size? I'll", "see you at the Champion's Guild.", "", "Champion of Imps")
            Items.CHAMPION_SCROLL_6804 -> arrayOf("You think you can defeat me? Come to the", "Champion's Guild and prove it!", "", "Champion of Jogres")
            Items.CHAMPION_SCROLL_6805 -> arrayOf("Come to the Champion's Guild so I can banish", "you mortal!", "", "Champion of Lesser Demons")
            Items.CHAMPION_SCROLL_6806 -> arrayOf("I'll be waiting at the Champions' Guild to collect", "your bones.", "", "Champion of Skeletons")
            Items.CHAMPION_SCROLL_6807 -> arrayOf("You come to Champions' Guild, you fight me, I", "squish you, I get brains!", "", "Champion of Zombies")
            Items.CHAMPION_SCROLL_6808 -> arrayOf("I challenge you to a fight! Meet me at the", "Champions' Guild so we can wrap this up.", "", "Champion of Mummies")
            else -> return
        }
