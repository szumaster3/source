...
open class AnagramClue : AnagramClueScroll {
    ...
    override fun newInstance(arg: Any?): Plugin<Any?>? {
        ...
        register(AnagramClue("arc_o_line", Items.CLUE_SCROLL_7245, "ARC O LINE", NPCs.CAROLINE_696, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        register(AnagramClue("are_col", Items.CLUE_SCROLL_7247, "ARE COL", NPCs.ORACLE_746, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        ...
        register(AnagramClue("by_look", Items.CLUE_SCROLL_7250, "BY LOOK", NPCs.BOLKOY_471, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        register(AnagramClue("c_on_game_hoc", Items.CLUE_SCROLL_7251, "C ON GAME HOC", NPCs.GNOME_COACH_2802, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        register(AnagramClue("dt_run_b", Items.CLUE_SCROLL_7252, "DT RUN B", NPCs.BRUNDT_THE_CHIEFTAIN_1294, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        register(AnagramClue("eek_zero_op", Items.CLUE_SCROLL_7253, "EEK ZERO OP", NPCs.ZOO_KEEPER_28, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        register(AnagramClue("el_ow", Items.CLUE_SCROLL_7254, "EL OW", NPCs.LOWE_550, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        register(AnagramClue("err_cure_it", Items.CLUE_SCROLL_7255, "ERR CURE IT", NPCs.RECRUITER_720, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        ...
        register(AnagramClue("got_a_boy", Items.CLUE_SCROLL_7258, "GOT A BOY", NPCs.GABOOTY_2520, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        ...
        register(AnagramClue("halt_us", Items.CLUE_SCROLL_7262, "HALT US", NPCs.LUTHAS_379, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        ...
        register(AnagramClue("lark_in_dog", Items.CLUE_SCROLL_7274, "LARK IN DOG", NPCs.KING_ROALD_648, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        ...
        register(AnagramClue("nod_med", Items.CLUE_SCROLL_7280, "NOD MED", NPCs.EDMOND_714, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        ...
        register(AnagramClue("ok_co", Items.CLUE_SCROLL_7284, "OK CO", NPCs.COOK_278, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
        ...
        register(AnagramClue("r_ak_mi", Items.CLUE_SCROLL_7292, "R AK MI", NPCs.KARIM_543, ClueLevel.HARD, PuzzleBox.getRandomPuzzleBox()))
