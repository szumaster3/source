...
public final class CrypticCluePlugin extends CrypticClueScroll {
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ...
        register(new CrypticCluePlugin("zanaris-forge", Items.CLUE_SCROLL_10244, ClueLevel.MEDIUM, "After a hard slays spraying<br>back the vegetation, why not<br>pop off to the nearby forge and<br>search the crates?", Location.create(2399, 4476, 0), 12105, new ZoneBorders(2398, 4475, 2400, 4477)));        register(new CrypticCluePlugin("port-khazard-anvil", Items.CLUE_SCROLL_10246, ClueLevel.MEDIUM, "After trawling for bars,<br>go to the nearest place and smith<br>them and dig by the door.", Location.create(2656, 3161, 0)));
