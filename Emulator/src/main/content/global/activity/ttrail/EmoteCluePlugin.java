...
public final class EmoteCluePlugin extends EmoteClueScroll {
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ...
        register(new EmoteCluePlugin("fishing-guild-blow", 2683, ClueLevel.HARD, emote, new int[][]{{2890}, {2493}, {1347}}, "Blow a raspberry in the<br>Fishing Guild bank. Beware<br>of double agents!<br>Equip an elemental shield<br>,blue dragonhide chaps<br>and a rune warhammer.", new ZoneBorders(2586, 3418, 2590, 3422)));
        emote = Emotes.CHEER;
