...
class ZombieHeadDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            1 -> {
                val nextStages = arrayOf(2, 7, 15, 27, 33)
                val index = buttonID - 1
                if (index in nextStages.indices) {
                    playerl(FaceAnim.ASKING, "Hey, Head?")
                    stage = nextStages[index]
                }
            }
            ...
            6 -> npcl(FaceAnim.FRIENDLY, "Well if I keep it all bottled up I'll turn into a total head case.").also { stage = 40 }
            ...
            14 -> npcl(FaceAnim.FRIENDLY, "Har har...").also { stage = 40 }
            ...
            26 -> playerl(FaceAnim.FRIENDLY, "Ok.").also { stage = 40 }
            ...
            32 -> npcl(FaceAnim.ANNOYED, "Because currently you wave me about by my hair, and it hurts.").also { stage = 40 }
            ...
            39 -> npcl(FaceAnim.ANNOYED, "If I try really hard I might be able to will myself deader...").also { stage = 40 }
            40 -> end()
        }
    }
}
