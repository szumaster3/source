...
@Initializable
class StormOfArmadylSpell : CombatSpell(
    ...
    null,
    Graphics(1334, 96),
    Projectile.create(null as Entity?, null, 1333, 0, 0, 62, 55, 0, 11),
    null,
    ...
    override fun cast(entity: Entity, target: Node): Boolean {
        ...
        if ((entity as Player).equipment.getNew(EquipmentContainer.SLOT_WEAPON).id != Items.ARMADYL_BATTLESTAFF_14696) {
