...
class PerduDialogue(
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            2 -> npcl(FaceAnim.OLD_DEFAULT, "You could get your stuff back elsewhere, sure. Now, maybe it'd be free, or maybe you'd have to pay someone, but you'd definitely have to go on a journey to get it back.").also { stage++ }
    ...
    override fun getIds(): IntArray {
        return intArrayOf(NPCs.PERDU_8592)
    }
}
