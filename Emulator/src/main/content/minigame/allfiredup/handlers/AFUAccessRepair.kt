...
class AFURepairClimbHandler : InteractionListener {
    ...
    /**
     * Gets the climbable or repairable object near the player.
     *
     * @param player The player attempting the interaction.
     * @return The [RepairClimbObject] near the player or `null` if none found.
     */
    ...
    /**
     * Attempts to repair the specified climbable object for the player.
     *
     * @param player The player performing the repair.
     * @param rco The repairable climb object.
     */
    ...
    /**
     * Makes the player climb up or down the specified climbable object.
     *
     * @param player The player climbing.
     * @param rco The climbable object.
     * @param location The current location of the climb action.
     */
    ...
    /**
     * Represents a climbable and repairable object in the All Fired Up minigame.
     *
     * @property varbit The varbit ID tracking the repair state of this object.
     * @property destinationUp The location at the top of the climbable object.
     * @property destinationDown The location at the bottom of the climbable object.
     * @property levelRequirement Optional skill and level required to repair this object.
     */
    private enum class RepairClimbObject(
        ...
        /**
         * Gets the opposite location to the player's current position (up or down).
         *
         * @param player The player interacting with the climb object.
         * @return The location opposite to the player's current location or null if not applicable.
         */
        fun getOtherLocation(player: Player): Location? =
            if (player.location == destinationDown) destinationUp else destinationDown

        /**
         * Gets the animation to use when the player climbs this object.
         *
         * @param player The player climbing.
         * @return The climbing animation.
         */
        ...
        /**
         * Gets the direction the player will face while climbing this object.
         *
         * @param player The player climbing.
        ...
        /**
         * Checks if this climbable object has been repaired by the player.
         *
         * @param player The player to check repair state for.
    ...
    companion object {
        /**
         * Checks if the specified beacon's climbable object has been repaired by the player.
         *
         * @param player The player to check.
         * @param beacon The beacon to check repair status for.
         * @return `true` if repaired, `false` otherwise.
         */
