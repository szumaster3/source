...
class PrivatePaldonDialogue(player: Player? = null, ) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int, ): Boolean {
        when (stage) {
            ...
            2 -> npcl(FaceAnim.HALF_GUILTY, "If I'm seen slacking off by talking to you, I'll be in deep trouble!").also { stage++ }
            3 -> playerl(FaceAnim.HALF_GUILTY, "Oh... Sorry.").also { stage = END_DIALOGUE }
        }
        return true
    }

    override fun getIds(): IntArray = intArrayOf(NPCs.PRIVATE_PALDON_5034)
}
