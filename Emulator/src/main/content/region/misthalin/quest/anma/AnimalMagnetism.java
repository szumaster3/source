...
public final class AnimalMagnetism extends Quest {
     ...
     */
    public static final Item CRONE_AMULET = new Item(Items.CRONE_MADE_AMULET_10500);

    /**
     * The constant SELECTED_IRON.
     */
    public static final Item SELECTED_IRON = new Item(Items.SELECTED_IRON_10488);

    /**
     * The constant RESEARCH_NOTES.
     */
    public static final Item RESEARCH_NOTES = new Item(Items.RESEARCH_NOTES_10492);

    /**
     * The constant TRANSLATED_NOTES.
     */
    public static final Item TRANSLATED_NOTES = new Item(Items.TRANSLATED_NOTES_10493);

    /**
     * The constant PATTERN.
     */
    public static final Item PATTERN = new Item(Items.A_PATTERN_10494);

    /**
     * The constant CONTAINER.
     */
    public static final Item CONTAINER = new Item(Items.A_CONTAINER_10495);

    /**
     * The constant POLISHED_BUTTONS.
     */
    public static final Item POLISHED_BUTTONS = new Item(Items.POLISHED_BUTTONS_10496);

    /**
     * The constant HARD_LEATHER.
     */
    public static final Item HARD_LEATHER = new Item(Items.HARD_LEATHER_1743);

    /**
     * The constant AVAS_ATTRACTOR.
     */
    public static final Item AVAS_ATTRACTOR = new Item(Items.AVAS_ATTRACTOR_10498);

    /**
     * The constant AVAS_ACCUMULATOR.
     */
    public static final Item AVAS_ACCUMULATOR = new Item(Items.AVAS_ACCUMULATOR_10499);
    ...
    public void finish(Player player) {
        ...
        player.getPacketDispatch().sendString("1000 XP in each of Crafting,", Components.QUEST_COMPLETE_SCROLL_277, 8 + 2);
        player.getPacketDispatch().sendString("Fletching and Slayer", Components.QUEST_COMPLETE_SCROLL_277, 9 + 2);
        player.getPacketDispatch().sendString("2500 Woodcutting XP", Components.QUEST_COMPLETE_SCROLL_277, 10 + 2);
        player.getPacketDispatch().sendString("1 Quest Point", Components.QUEST_COMPLETE_SCROLL_277, 11 + 2);
        player.getPacketDispatch().sendString("Ava's device", Components.QUEST_COMPLETE_SCROLL_277, 12 + 2);
        player.getPacketDispatch().sendItemZoomOnInterface(item.getId(), 235, Components.QUEST_COMPLETE_SCROLL_277, 3 + 2);
