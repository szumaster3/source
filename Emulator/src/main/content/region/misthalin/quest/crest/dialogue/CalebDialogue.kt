...
class CalebDialogue(
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            403 ->
                if (player.inventory.containItems(CREST_PIECE.id, 782) ||
                    player.bank.containItems(
                        CREST_PIECE.id,
                        782,
                    )
                ) {
            ...
            405 ->
                sendDialogue("Caleb hands over his crest piece to you again.").also {
                    stage++
                    player.inventory.add(CREST_PIECE)
                }
            ...
            6000 ->
                when (buttonId) {
                    1 -> {
                        ...
                        npc(
                            "Yes certainly, though it will cost you 25,000 coins" +
                                if (freeThisTime) " next time." else ".",
                        ).also {
                            stage = 6001
                        }
                    }
