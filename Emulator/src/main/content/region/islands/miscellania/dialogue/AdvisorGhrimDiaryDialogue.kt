package content.region.islands.miscellania.dialogue
...
class AdvisorGhrimDiaryDialogue : DialogueFile() {
    override fun handle(
        ...
        when (stage) {
            0 ->
                if (player!!.achievementDiaryManager.getDiary(DiaryType.FREMENNIK)!!.isComplete(2, true) &&
                    !Diary.hasClaimedLevelRewards(player!!, DiaryType.FREMENNIK, 2)
                ) {
            ...
            17 ->
                npc(
                    FaceAnim.NEUTRAL,
                    "Some of the Fremennik set's Tasks are simple, some will",
