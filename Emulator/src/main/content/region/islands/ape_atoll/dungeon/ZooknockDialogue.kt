package content.region.islands.ape_atoll.dungeon
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            62 -> when (buttonId) {
                ...
                3 -> player(FaceAnim.ASKING, "Where do I find something to do with monkey speech?").also {
                    stage = 90
                }
            ...
            112 -> npcl(FaceAnim.OLD_CALM_TALK1, "Then bring me different monkey remains and another talisman.").also {
                stage = 101
            }
