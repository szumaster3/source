package content.region.karamja.handlers.shilo.dialogue.shilovillage

import content.region.karamja.handlers.shilo.ANTIQUE_ITEMS
...
class YanniSalikaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int, ): Boolean {
        when (stage) {
            0 -> npc(FaceAnim.FRIENDLY, "Greetings Bwana! My name is Yanni and I buy and sell", "antiques.").also { stage++ }
