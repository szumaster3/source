package content.region.karamja.quests.mm.handlers

import content.region.islands.ape_atoll.dungeon.ZooknockAfterBattleDialogueFile
import content.region.islands.ape_atoll.dungeon.ZooknockDialogue
import content.region.islands.ape_atoll.dungeon.ZooknockDialogueFile
    ...
    override fun defineListeners() {
        ...
        on(NPCs.MONKEY_MINDER_1469, IntType.NPC, "talk-to") { player, npc ->
            if (!inEquipment(player, Items.MONKEY_GREEGREE_4031)) {
                openDialogue(player, content.region.karamja.quests.mm.dialogue.MonkeyMinderHumanDialogue(), npc)
            } else {
