...
class DaeroTrainingPostQuestDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            7 -> npcl(FaceAnim.OLD_DEFAULT, "Enthusiasm. I like that. We will first begin with a series of exercises designed to increase your strength and stamina.").also { stage++ }
            8 -> npcl(FaceAnim.OLD_DEFAULT, "We then will follow these up by improving your attack and defence techniques.").also { stage++ }
            9 -> npcl(FaceAnim.OLD_DEFAULT, "You will improve your strength, stamina, attack and defence, but you may choose what you want to focus on.").also { stage++ }
