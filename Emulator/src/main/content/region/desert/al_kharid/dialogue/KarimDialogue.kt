    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npcl(
                ...
                "I don't like him. He makes all these claims about being the best salesman in the world, and he even has some thugs that he's hired to threaten us."
            ).also { stage++ }

            4 -> npcl(
                FaceAnim.HALF_GUILTY,
                "One of them came round here and threatened to cut my head off if I didn't cooperate with them!"
            ).also { stage++ }

            5 -> npcl(
                FaceAnim.HALF_GUILTY,
                "I've also heard some rumours about them from my friend Isma'il in Pollnivneach..."
            ).also { stage++ }

            6 -> player(FaceAnim.HALF_ASKING, "What sort of rumours?").also { stage++ }
            7 -> npcl(
                FaceAnim.HALF_GUILTY, "Apparently he has men there as well, who have also been threatening people."
            ).also { stage++ }

            8 -> npcl(
                FaceAnim.HALF_GUILTY,
                "And it's said that they even intend to steal from the ruler of Al Kharid himself!"
            ).also { stage++ }

            9 -> player(FaceAnim.HALF_ASKING, "Really?").also { stage++ }
            10 -> npcl(
                FaceAnim.HALF_ASKING, "That's what I've heard. Anyway, are you sure you wouldn't like a kebab?"
            ).also { stage = 0 }
