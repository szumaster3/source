...
class NathifaDialogue(
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            7 -> npcl(
                FaceAnim.SAD,
                "They were still allowing citizens from Sophanem to return at that point, but I foolishly chose to stay. I was scared of catching the pox."
            ).also { stage++ }

            8 -> npcl(
                FaceAnim.SAD,
                "By the time I'd changed my mind, they'd stopped letting anyone through. Thankfully, I had some friends there with a spare bed."
            ).also { stage++ }
            ...
            11 -> npcl(
                FaceAnim.SAD,
                "They quickly put a stop to it in the Imperial and Merchant quarters, but there was still some unrest in the Workers district when I was finally able to leave."
            ).also { stage++ }

            12 -> playerl(
                FaceAnim.HALF_GUILTY,
                "I'm sorry you had to go through all of that. Menaphos definitely took a hard stance on the plagues."
            ).also { stage++ }

            13 -> npcl(
                FaceAnim.SAD,
                "They were brutal. They even shut off the port from the rest of the city over fears of the plague getting in that way. Many of their own citizens are still trapped there."
            ).also { stage++ }
