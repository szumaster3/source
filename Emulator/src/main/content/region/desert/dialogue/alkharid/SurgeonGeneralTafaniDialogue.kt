...
@Initializable
class SurgeonGeneralTafaniDialogue(
    player: Player? = null,
) : Dialogue(player) {
        ...
        when (stage) {
            100 ->
                showTopics(
                    ...
                    IfTopic(
                        "Can I buy a Skillcape of Hitpoints from you?",
                        401,
                        hasLevelStat(player, Skills.HITPOINTS, 99),
                    ),
            ...
            401 ->
                npcl(
                    FaceAnim.FRIENDLY,
                    "Why, certainly my friend. However, owning such an item makes you part of an elite group and that privilege will cost you 99000 coins.",
                ).also {
                    stage++
                }
            402 ->
            ...
            411 ->
                npcl(FaceAnim.NEUTRAL, "I'm sorry you feel that way. Still, if you change your mind...").also {
                    stage =
                        END_DIALOGUE
                }
            421 ->
            ...
            501 ->
                npcl(
                    FaceAnim.HALF_THINKING,
                    "Well, these capes are only available for people who have achieved a Hitpoint level of 99. You should go and train some more and come back to me when your Hitpoints are higher.",
                ).also {
                    stage =
                        END_DIALOGUE
                }
