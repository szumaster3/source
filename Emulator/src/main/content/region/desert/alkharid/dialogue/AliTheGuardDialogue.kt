...
class AliTheGuardDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            12 -> npcl(FaceAnim.FRIENDLY, "Pollnivneach. It's a town to the south of the Shantay Pass.").also {
                stage = 1
            }
            ...
            37 -> npcl(FaceAnim.FRIENDLY, "Why not? He always likes to meet potential business partners.").also {
                stage = 1
            }
            ...
            42 -> npcl(FaceAnim.LOUDLY_LAUGHING, "Why bother? None of them can fight back, after all.").also {
                stage = END_DIALOGUE
            }
        }
        return true
