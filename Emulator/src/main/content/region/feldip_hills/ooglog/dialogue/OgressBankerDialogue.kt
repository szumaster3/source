package content.region.feldip_hills.ooglog.dialogue
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            4 -> sendNPCDialogue(
                player,
                NPCs.BALNEA_7047,
                "We'll be open as soon as we realize our customer experience goals " + "and can guarantee the high standards of service that you expect from all " + "branches of the Bank of Gielinor.",
                FaceAnim.FRIENDLY,
            ).also { stage++ }
