    ...
    override fun handle(
        ...
        when (stage) {
            ...
            4 ->
                playerl(
                    FaceAnim.FRIENDLY,
                    "Uhm... I'm just looking for some pickaxes! Do you have any?",
                ).also { stage++ }
            5 ->
                npcl(
                    FaceAnim.OLD_ANGRY1,
                    "Do I have any pickaxes? Do I? Of course I do, this is a pickaxe shop, isn't it!",
                ).also {
                    stage++
                }
            6 -> {
            ...
            10 ->
                npcl(
                    FaceAnim.OLD_ANGRY1,
                    "I don't have any lousy quests... I've got someone who's helping me already!",
                ).also {
                    stage++
                }
            11 ->
                npcl(
                    FaceAnim.OLD_ANGRY1,
                    "Well, I say helping... he takes his merry time to do his chores, my son does.",
                ).also {
                    stage++
                }
            12 -> playerl(FaceAnim.FRIENDLY, "Then perhaps I can help in some way?").also { stage++ }
            13 ->
                npcl(FaceAnim.OLD_ANGRY1, "Pfft, I doubt it... maybe when my son fouls up again, but not now.").also {
                    stage =
                        END_DIALOGUE
                }
