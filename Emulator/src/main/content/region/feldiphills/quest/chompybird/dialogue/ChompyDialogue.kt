package content.region.feldiphills.quest.chompybird.dialogue
...
class ChompyDialogue(
    ...
    private fun handleQuestStartDialogue(
        ...
        when (stage) {
            ...
            6 -> npcl(FaceAnim.OLD_NORMAL, "Yeah, is what Rantz sayed, make da stabbers for da stabby chucker!").also {
                stage = 1
            }
            ...
            10 -> npcl(
                ...
                stage = END_DIALOGUE; quest.start(player)
            }
        }
    }
    ...
    private fun handleToadsiesDialogue(
        ...
        when (stage) {
            ...
            11 -> npcl(FaceAnim.OLD_NORMAL, "Ok creature? You got dat? Over here by der no tree's place.").also {
                stage = 4
            }
    ...
    private fun handleWaitingForChompyDialogue(
        ...
        when (stage) {
            ...
            103 -> npcl(
                FaceAnim.OLD_NORMAL,
                "But's we's particular about our chompy yumms. Me's wants ${
                    getItemName(
                        rantzIngredient,
                    )
