...
/**
 * Represents the Makeover Mage dialogue.
 */
@Initializable
class MakeOverMageDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        npc(FaceAnim.HAPPY, "Hello there! I am known as the make-over mage! I", "have spent many years researching magics that can", "change your physical appearance!")
        return true
    }
        ...
        when (stage) {
            ...
            25 -> {
                ...
                if (!player.equipment.isEmpty) {
                    sendDialogueLines(player, "You need to take off all your equipment before the mage", "can change your appearance.")
                    return true
                } else {
