    ...
    override fun defineListeners() {
        on(Rooms.statueIDs, IntType.SCENERY, "touch") { player, node ->
            ...
            if (node.id == Rooms.statueIDs[correctStatue]) {
                ...
                openDialogue(player, content.region.asgarnia.falador.quest.rd.plugin.LadyTablePuzzleListener(2), NPC(NPCs.LADY_TABLE_2283))
            }
            return@on true
        }
        ...
        fun initRoomStage(
            ...
            when (npc) {
                ...
                NPCs.LADY_TABLE_2283 -> openDialogue(player,
                    content.region.asgarnia.falador.quest.rd.plugin.LadyTablePuzzleListener(1), NPC(npc))
