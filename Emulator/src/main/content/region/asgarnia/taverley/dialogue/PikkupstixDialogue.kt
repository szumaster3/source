...
class PikkupstixDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
            0 -> when (stage) {
                0 -> player("I'm just a passing adventurer. Who are you?").also { stage++ }
                ...
                3 -> player("What do you do here?").also { stage++ }
                ...
                12 -> player("How complicated can it be?").also { stage++ }
            ...
            20 -> when (stage) {
                ...
                3 -> player("What IS it?").also { stage++ }
                ...
                6 -> player("So, what can be done about it? Can't you banish it?").also { stage++ }
                ...
                11 -> player("Well, what if I were to bring you the elements you", "needed? Would that work?").also { stage++ }
                ...
                15 -> player("What do you need me to bring?").also { stage++ }
                16 -> npc("That's wonderful!").also { stage++ }
            ...
            40 -> when (stage) {
                ...
                5 -> player("What sort of powers?").also { stage++ }
                ...
                8 -> player("Great! So, how will I make it perform that Summoning", "scroll?").also { stage++ }
                ...
                20 -> player("What are these things?").also { stage++ }
                ...
                25 -> player("Okay, I think I understood that. So, how do I get the", "obelisk to work?").also { stage++ }
            ...
            60 -> when (stage) {
                ...
                21 -> player("Won't my energy renew on its own?").also { stage++ }
                ...
                26 -> player("Thanks for the information.").also { stage++ }
            ...
            100 -> when (stage) {
                ...
                1 -> when (buttonId) {
                    1 -> player("So, what's summoning all about, then?").also { stage = 10 }
                    2 -> player("Can I buy some summoning supplies, please?").also { stage = 34 }
                    3 -> player("Please tell me about Skillcapes.").also { stage = 400 }
                }
                ...
                600 -> when (buttonId) {
                    1 -> player("So, what's summoning all about, then?").also { stage = 10 }
                    2 -> player("Can I buy some summoning supplies, please?").also { stage = 34 }
                    3 -> player("Can I buy a Skillcape of Summoning?").also { stage = 599 }
