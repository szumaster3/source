...
import content.region.morytania.port_phasmatys.quest.ahoy.dialogue.AkharanuDialogueFile
...
class AkharanuDialogue(
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        if (inInventory(player!!, Items.SIGNED_OAK_BOW_4236) || getQuestStage(player, Quests.GHOSTS_AHOY) >= 5) {
            ...
            openDialogue(player, content.region.morytania.port_phasmatys.quest.ahoy.dialogue.AkharanuDialogueFile())
        } else {
