package content.region.morytania.phasmatys.quest.ahoy.plugin
...
class GiantLobsterNPC(
    ...
    override fun construct(
        ...
        location: Location,
        vararg objects: Any,
    ): AbstractNPC = content.region.morytania.phasmatys.quest.ahoy.plugin.GiantLobsterNPC(id, location)
    ...
    companion object {
        fun spawnGiantLobster(player: Player) {
            val giantLobster =
                content.region.morytania.phasmatys.quest.ahoy.plugin.GiantLobsterNPC(NPCs.GIANT_LOBSTER_1693)
    ...
    override fun finalizeDeath(killer: Entity?) {
        if (killer is Player) {
            ...
            setAttribute(killer,
                content.region.morytania.phasmatys.quest.ahoy.plugin.GhostsAhoyUtils.lastMapScrap, true)
        }
        clear()
