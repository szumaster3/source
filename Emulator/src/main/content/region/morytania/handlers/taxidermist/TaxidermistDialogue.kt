...
class TaxidermistDialogue(player: Player? = null, ) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int, ): Boolean {
        when (stage) {
            ...
            3 -> npcl(FaceAnim.HALF_GUILTY, "If you bring me a monster head or a very big fish, I can preserve it for you so you can mount it in your house.").also { stage++ }
            4 -> npc(FaceAnim.HALF_GUILTY, "I hear there are all sorts of exotic creatures in the Slayer Tower - I'd like a chance to stuff one of them!").also { stage = END_DIALOGUE }
            5 -> npc(FaceAnim.HAPPY, "Give it to me to look at then.").also { stage = END_DIALOGUE }
        }
        return true
    }
