package content.region.morytania.plugin.tarnslair.dialogue
...
class OdovacarDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int, ): Boolean {
        when (stage) {
            ...
            13 -> npcl(FaceAnim.HALF_GUILTY, "Please come again, when you have 100 gold to cover the fee.").also {
                stage = END_DIALOGUE
            }
            ...
            17 -> npcl(
                FaceAnim.HALF_GUILTY,
                "They acted as if we didn't know what town we were in or something."
            ).also {
                stage = END_DIALOGUE
            }
        }
