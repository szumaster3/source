...
class ValdezDialogue(
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            // First path.
            1001 -> npc(FaceAnim.HALF_GUILTY, "Ah, the infamous Rennard...", "The last I had heard of him, he had sought passage on a", "ship crewed by none but the most dastardly lowly pirates...", "I also heard that this ship had been caught in a").also { stage = 10001 }
            10001 -> npcl(FaceAnim.HALF_GUILTY, "violent storm, and stranded upon rocks, where the pirates then made their home...").also { stage = 35 }

            // Second path.
            1002 -> npc(FaceAnim.HALF_GUILTY, "Ah, the infamous Rennard...", "The last I had heard of that vile thief, he had joined a", "group of bandits in a barren land to the South-east of", "here, where they prey upon the unsuspecting visitors to").also { stage = 10002 }
            10002 -> npc(FaceAnim.HALF_GUILTY, "the desert awaiting the return of their dark master...").also { stage = 35 }

            // Third path.
            1003 -> npc(FaceAnim.HALF_GUILTY, "Ah, the infamous Rennard...", "The last I had heard of that vile thief, he had joined a", "group of bandits in an evil land to the North-east of", "here, where they had made their home living outside of").also { stage = 10003 }
            10003 -> npc(FaceAnim.HALF_GUILTY, "the reach of the authorities that pursued them...").also { stage = 35 }
        }
        return true
    }
