...
class TrainingGroundListener : InteractionListener {
    override fun defineListeners() {
        ...
        on(intArrayOf(Scenery.LARGE_DOOR_25594, Scenery.LARGE_DOOR_25595), IntType.SCENERY, "open") { player, _ ->
            ...
            val kwComplete = getAttribute(player, KnightWaveAttributes.KW_COMPLETE, false)
            val kwBegin = getAttribute(player, KnightWaveAttributes.KW_BEGIN, false)
            ...
            if (player.location.x >= 2752 && kwBegin) {
