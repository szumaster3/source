...
object FishingPlatform {
    ...
    /**
     * Represents travel routes from or to the fishing platform.
     */
    enum class Travel(val destName: String, val destinationLoc: Location, val component: Int, val ticks: Int, ) {
        WITCHAVEN_TO_FISHING_PLATFORM("at the fishing platform", Location(2782, 3273, 0), 10, 8),
        FISHING_PLATFORM_TO_WITCHAVEN("at Witchaven", Location(2719, 3301, 0), 11, 12),
        FISHING_PLATFORM_TO_SMALL_ISLAND("on a small island", Location(2800, 3320, 0), 12, 12),
        SMALL_ISLAND_TO_FISHING_PLATFORM("at the fishing platform", Location(2782, 3273, 0), 13, 10),
    }
}
