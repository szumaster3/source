...
class ShopkeeperDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            0 -> npcl(FaceAnim.THINKING, "So, are you looking to buy weapons? King Lathas keeps us very well stocked.").also {
                stage++
            }
    ...
    override fun getIds(): IntArray = intArrayOf(NPCs.SHOPKEEPER_561)
}
