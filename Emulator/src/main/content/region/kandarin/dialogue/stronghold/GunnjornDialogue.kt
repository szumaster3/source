...
class GunnjornDialogue(
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        if (questProgress >= 1 && !inInventory(player, Items.LIGHTHOUSE_KEY_3848) && !isQuestComplete(
                player, Quests.HORROR_FROM_THE_DEEP
            )
        ) {
            options(
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            25 -> {
                ...
                setVarbit(player, HorrorFromTheDeep.LIGHTHOUSE_KEY_OBTAINED, 1, true)
            }
