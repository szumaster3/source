...
class HuntingExpertDialogue(player: Player? = null, ) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int, ): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                ...
                4 -> player(FaceAnim.HALF_GUILTY, "Ahh, leave me alone you crazy killing person.").also {
                    stage = 115
                }
            }
            ...
            13 -> when (buttonId) {
                ...
                2 -> player(FaceAnim.HALF_GUILTY, "What sort of things are there to catch around here?").also {
                    stage = 110
                }

                3 -> player(FaceAnim.HALF_GUILTY, "How can I improve my chances of making a capture?").also {
                    stage = 111
                }

                4 -> player(FaceAnim.HALF_GUILTY, "Where can I get clothes and equipment like yours?").also {
                    stage = 112
                }

                5 -> player(FaceAnim.HALF_GUILTY, "I think I'll give it a miss right now, thanks.").also {
                    stage = 117
                }
            }
    ...
    companion object {
        private val ITEMS = arrayOf(
            Item(Items.HUNTER_CAPE_9948),
            Item(Items.HUNTER_CAPET_9949),
            Item(Items.HUNTER_HOOD_9950)
        )
