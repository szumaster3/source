package content.region.kandarin.diaries
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            1 -> when (buttonId) {
                ...
                3 -> if (Diary.canReplaceReward(player, DiaryType.SEERS_VILLAGE, diaryLevel)) {
            ...
            91 -> npc(FaceAnim.OLD_DEFAULT, "your flax allowance in acknowledgement of your", "standing.").also {
                stage = END_DIALOGUE
            }
            ...
            204 -> npc(
                FaceAnim.OLD_DEFAULT, "increase your flax allowance in acknowledgement of your", "standing."
            ).also {
                stage = END_DIALOGUE
            }
        }
