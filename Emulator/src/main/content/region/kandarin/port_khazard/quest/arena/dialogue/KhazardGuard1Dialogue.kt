...
class KhazardGuard1Dialogue(
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        if (isQuestComplete(player, Quests.FIGHT_ARENA)) {
            npcl(FaceAnim.FRIENDLY, "It's you! I don't believe it. You beat the General! You are a traitor to the uniform!").also { stage = END_DIALOGUE }
    ...
    override fun getIds(): IntArray = intArrayOf(NPCs.KHAZARD_GUARD_253)
}
