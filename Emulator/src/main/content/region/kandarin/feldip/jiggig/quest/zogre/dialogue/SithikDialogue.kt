...
class SithikIntsDragonTankardDialogueFile : DialogueFile() {
    override fun handle(
        ...
        when (stage) {
            ...
            5 -> npcl("When do you think you'll start questioning the remaining population of Yanille?").also {
                stage = END_DIALOGUE
            }
        }
    }
...
class SithikIntsSignedPortraitDialogueFile : DialogueFile() {
    override fun handle(
        ...
        when (stage) {
            ...
            14 -> player(FaceAnim.SAD, "You're a mean and cruel man Sithik, a mean and cruel man!").also {
                stage = END_DIALOGUE
            }
        }
    }
