...
class ObservatoryAssistantDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            1 -> npcl(FaceAnim.HALF_GUILTY, "Me? I'm always busy. See that man there? That's the professor. If he had his way, I think he'd never let me sleep! Anyway, how might I help you?").also { stage++ }
...
class AssistantTalkAboutObservatoryDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            4 -> npcl("Well, since the bridge was ruined, you will have to travel through the dungeon under the goblins' settlement.").also { stage = END_DIALOGUE }
        }
    }
}
