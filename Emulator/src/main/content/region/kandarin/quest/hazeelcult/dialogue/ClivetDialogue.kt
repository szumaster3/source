    ...
    override fun handle(
        ...
        when {
            ...
            (questStage == 2) -> when (stage) {
                0 -> {
                    if (getAttribute(player!!, MAHJARRAT, true) && !inInventory(
                            player, Items.POISON_273
            ...
            (questStage == 100) -> when (stage) {
                ...
                1 -> npcl(FaceAnim.FRIENDLY, "It is good to see you once more, adventurer. Glory to Hazeel!").also {
                    stage = END_DIALOGUE
                }
