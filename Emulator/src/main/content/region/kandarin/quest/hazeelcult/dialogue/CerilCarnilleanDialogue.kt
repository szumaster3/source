...
class CerilCarnilleanDialogue(
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        if (getQuestStage(player, Quests.HAZEEL_CULT) == 1) {
            playerl(FaceAnim.FRIENDLY, "Hello, Ceril.")
        } else if (getAttribute(player!!, CARNILLEAN, true) && getQuestStage(player, Quests.HAZEEL_CULT) == 4) {
            playerl(FaceAnim.FRIENDLY, "I've killed the cult leader, and he dropped your armour!")
        } else if (getAttribute(player!!, CARNILLEAN, true) && getQuestStage(
                player, Quests.HAZEEL_CULT
            ) == 5 && inBorders(player, 2571, 3267, 2575, 3273)
        ) {
            npcl(
    ...
    override fun handle(
        ...
        when (getQuestStage(player!!, Quests.HAZEEL_CULT)) {
            ...
            5 -> when (stage) {
                ...
                4 -> sendDialogue(player, "Sir Ceril gives you 5 coins. Sir Ceril gives Jones 1,995 coins.").also {
