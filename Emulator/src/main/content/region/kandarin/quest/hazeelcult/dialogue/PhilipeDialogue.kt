    ...
    override fun handle(
        ...
        when {
            ...
            (questStage in 1..2) -> when (stage) {
                0 -> npcl(
                    FaceAnim.CHILD_NORMAL, "Mommy said you're here to kill all the nasty people that keep breaking in."
                ).also { stage++ }
            ...
            (questStage == 3) -> when (stage) {
                ...
                1 -> npcl(
                    FaceAnim.CHILD_SAD, "Someone killed Scruffy. I liked Scruffy. He never told me off."
                ).also { stage++ }
            ...
            (questStage == 100) -> when (stage) {
                ...
                7 -> playerl(FaceAnim.FRIENDLY, "I'll try and console myself about that disappointment somehow.").also {
                    stage = END_DIALOGUE
                }
            }
        }
