        ...
        when {
            inInventory(player!!, Items.ORBS_OF_PROTECTION_588) && followLocation == "exit" -> {
                when (stage) {
                    ...
                    1 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "Take it to King Bolren, I'm sure he'll be pleased to see you.",
                        ).also { stage++ }
                    ...
                    4 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "If you like, but please take the orb to King Bolren soon.",
                        ).also { stage++ }
                    5 -> {
                    ...
                    6 ->
                        npcl(FaceAnim.OLD_NORMAL, "Here we are. Please don't lose the orb!").also {
                            stage = END_DIALOGUE
                        }
                }
            }
                ...
                when (stage) {
                    ...
                    3 -> {
                        if (locY > 3161) {
                            npcl(
                                FaceAnim.OLD_NORMAL,
                                "You're our saviour. Please return it to the village and we are all saved. Would you like me to show you the way to the village?",
                            ).also {
                                stage++
                            }
                        } else {
                            npcl(
                                FaceAnim.OLD_NORMAL,
                                "Take the orb to King Bolren, I'm sure he'll be pleased to see you.",
                            ).also {
                                stage =
                                    END_DIALOGUE
                            }
                    ...
                    8 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "Here we are. Take the orb to King Bolren, I'm sure he'll be pleased to see you.",
                        ).also {
                            stage =
                                END_DIALOGUE
                        }
            ...
            inInventory(player!!, Items.ORBS_OF_PROTECTION_588) || questStage == 100 -> {
                when (stage) {
                    ...
                    3 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "You saved us by defeating the warlord. I'm humbled and wish you well.",
                        ).also { stage++ }
                    4 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "Would you like me to show you the way to the $followLocation?",
                        ).also { stage++ }
                    ...
                    10 ->
                        npcl(FaceAnim.OLD_NORMAL, "Here we are. Feel free to have a look around.").also {
                            stage = END_DIALOGUE
                        }
                }
            }
            ...
            questStage == 0 -> {
                when (stage) {
                    ...
                    1 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "Hello, welcome to our maze. I'm Elkoy the tree gnome.",
                        ).also { stage++ }
                    2 -> playerl("I haven't heard of your sort.").also { stage++ }
                    3 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "There's not many of us left. Once you could find tree gnomes anywhere in the world, now we hide in small groups to avoid capture.",
                        ).also {
                            stage++
                        }
                    ...
                    5 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "Tree gnomes have been hunted for so called 'fun' since as long as I can remember.",
                        ).also {
                            stage++
                        }
                    6 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "Our main threat nowadays are General Khazard's troops. They know no mercy, but are also very dense. They'll never find their way through our maze.",
                        ).also {
                            stage++
                        }
            ...
            questStage in 1..39 -> {
                when (stage) {
                    ...
                    7 ->
                        npcl(FaceAnim.OLD_NORMAL, "Here we are. I hope you get the orb back soon.").also {
                            stage = END_DIALOGUE
                        }
                }
            }
            ...
            questStage == 40 -> {
                when (stage) {
                    ...
                    1 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "Did you hear? Khazard's men have pillaged the village! They slaughtered many, and took the other orbs in an attempt to lead us out of the maze. When will the misery end?",
                        ).also {
                            stage++
                        }
                    2 ->
                    ...
                    7 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "Please try to get our orbs back for us, otherwise the village is doomed!",
                        ).also {
                            stage =
                                END_DIALOGUE
                        }
                    8 ->
                        npcl(
                            FaceAnim.OLD_NORMAL,
                            "Here we are. Despite what has happened here, I hope you feel welcome.",
                        ).also {
                            stage =
                                END_DIALOGUE
                        }
