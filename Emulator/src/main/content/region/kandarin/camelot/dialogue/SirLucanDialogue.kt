    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        if (!isQuestComplete(player, Quests.MERLINS_CRYSTAL)) {
            when (stage) {
                ...
                11 -> {
                    npcl(FaceAnim.NEUTRAL, "I've tried all the weapons I can find, yet none are powerful enough to break his crystal prison...")
                    stage++
                }
                ...
                13 -> {
                    npcl(FaceAnim.NEUTRAL, "The Lady of the Lake is looking after it I believe... but I know not where she resides currently.")
                    stage++
                }
