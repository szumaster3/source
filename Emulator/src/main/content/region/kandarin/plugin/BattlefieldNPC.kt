...
class BattlefieldNPC(id: Int = 0, location: Location? = null, ) : AbstractNPC(id, location) {
    ...
    override fun construct(id: Int, location: Location, vararg objects: Any): AbstractNPC = BattlefieldNPC(id, location)
    ...
    companion object {
        ...
        private val GNOMES_FORCE_CHAT = arrayOf("Stop right there, Khazard scum!", "Tally Ho!", "We are the true force of the battlefield!", "Feel the wrath of the goblins!")
    }
}
