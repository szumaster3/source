package content.region.kandarin.plaguecity.dialogue
    ...
    override fun handle(
        ...
        when (RandomFunction.random(1, 4)) {
            1 -> when (stage) {
                ...
                3 -> when (buttonID) {
                    1 -> playerl(FaceAnim.FRIENDLY, "Have you seen a lady called Elena around here?").also {
                        stage = 4
                    }
            ...
            2 -> when (stage) {
                ...
                3 -> when (buttonID) {
                    1 -> playerl(FaceAnim.FRIENDLY, "Yes, living in a plague city must be hard.").also {
                        stage = 4
                    }
                ...
                6 -> npcl(FaceAnim.FRIENDLY, "Well, ain't much either you or me can do about it.").also {
                    stage = END_DIALOGUE
                }
