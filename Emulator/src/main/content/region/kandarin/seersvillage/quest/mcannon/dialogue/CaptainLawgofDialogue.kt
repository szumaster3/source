package content.region.kandarin.seersvillage.quest.mcannon.dialogue
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
            ...
            10 ->
                when (stage) {
                    0 -> {
                        if (content.region.kandarin.seersvillage.quest.mcannon.DwarfCannon.allRailsFixed(player)) {
                            npc(
                                FaceAnim.OLD_NORMAL,
            ...
            20 ->
                when (stage) {
                    0 -> {
                        if (player.inventory.containsItem(content.region.kandarin.seersvillage.quest.mcannon.DwarfCannon.DWARF_REMAINS)) {
                    ...
                    5 -> {
                        interpreter.sendItemMessage(
                            content.region.kandarin.seersvillage.quest.mcannon.DwarfCannon.DWARF_REMAINS,
                    ...
                    10 -> {
                        ...
                        player.inventory.remove(content.region.kandarin.seersvillage.quest.mcannon.DwarfCannon.DWARF_REMAINS)
            ...
            40 ->
                when (stage) {
                    ...
                    8 -> {
                        player.inventory.add(content.region.kandarin.seersvillage.quest.mcannon.DwarfCannon.TOOL_KIT, player)
                        setVarp(player, 0, 7)
            ...
            50 ->
                when (stage) {
                    ...
                    1 -> {
                        if (!player.hasItem(content.region.kandarin.seersvillage.quest.mcannon.DwarfCannon.TOOL_KIT)) {
            ...
            60 ->
                when (stage) {
                    ...
                    13 -> {
                        player.inventory.remove(content.region.kandarin.seersvillage.quest.mcannon.DwarfCannon.TOOL_KIT)
            ...
            80 ->
                when (stage) {
                    ...
                    2 ->
                        if (!player.inventory.containsItem(content.region.kandarin.seersvillage.quest.mcannon.DwarfCannon.MOULD) ||
                            !player.inventory.containsItem(content.region.kandarin.seersvillage.quest.mcannon.DwarfCannon.NULODION_NOTES)
                        ) {
