...
class CannonTimer : RSTimer(1, "dmc:timer") {
    lateinit var dmcHandler: content.region.kandarin.seersvillage.quest.mcannon.plugin.DMCHandler
    ...
    override fun getTimer(vararg args: Any): RSTimer {
        ...
        t.dmcHandler = args[0] as content.region.kandarin.seersvillage.quest.mcannon.plugin.DMCHandler
        return t
    }
}
