package content.region.other.dorgeshkaan.dialogue
...
class BarlakDialogue(
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            999 ->
                sendDialogue("Barlak gives you a short lecture and you learn more about Construction.").also {
                    stage =
                        99
                }
            1000 ->
                sendDialogue("Barlak gives you a short lecture and you learn more about Crafting.").also {
                    stage =
                        99
                }
            1001 ->
