...
import content.region.fremennik.waterbirthisland.plugin.TravelDestination
import content.region.fremennik.waterbirthisland.plugin.WaterbirthUtils.sail
...
class MariaGunnarsDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            38 -> npcl(FaceAnim.HALF_GUILTY, "Where was I? Yup, that covers the layout of the islands.").also {
                stage = END_DIALOGUE
            }
