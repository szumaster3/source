    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            7 -> showTopics(
                ...
                Topic("Nice hat!", 27, true),
                Topic("Ok, 'bye.", 36, true),
            )
            ...
            11 -> player(FaceAnim.HALF_THINKING,"Hey, scary barbarian type guy, think I can join you on this expedition?").also {
                setVarbit(player, 814, 1, true)
                stage++
            }
            12 -> playerl(FaceAnim.HALF_ASKING,"Hey, scary barbarian type guy, think I can join you on this expedition?").also { stage++ }
            13 -> npcl(FaceAnim.THINKING,"An outerlander join us on an honoured hunt??? Well.... I guess... I might be able to allow you to join us, although it is a breach of many of our customs...").also { stage++ }
            14 -> player(FaceAnim.HALF_GUILTY,"Oh, pleeeeease? I really LOVE killing stuff!").also { stage++ }
            15 -> npcl(FaceAnim.FRIENDLY,"Well... I remain unconvinced that it would be wise to allow an outerlander to join us in such dangerous battle, but your enthusiasm seems genuine enough... I will allow you to escort us, but you must pay me a sum of money first.").also { stage++ }
            ...
            25 -> npcl(FaceAnim.HALF_GUILTY,"As you wish. Come and see me when your bloodlust needs sating.").also { stage++ }
            26 -> end()
            ...
            30 -> npc(FaceAnim.NEUTRAL, "Have you had your fill of the hunt and wish to return,", "or are you still feeling the joy of the cull?",).also { stage++ }
            31 -> sendDialogueOptions(player, "Leave island?", "YES", "NO").also { stage++ }
            32 -> when (buttonId) {
                1 -> {
            ...
            33 -> playerl(FaceAnim.HALF_GUILTY, "Actually, I don't think I have anything to speak to you about...").also { stage = 37 }
            34 -> playerl(FaceAnim.HALF_GUILTY, "Wow, you Fremenniks sure know how to party. Well, see ya around.").also { stage++ }
            35 -> end()
        }
        return true
    }
