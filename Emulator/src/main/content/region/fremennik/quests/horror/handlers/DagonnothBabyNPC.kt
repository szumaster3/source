...
import content.region.fremennik.quests.horror.JossikLighthouseDialogue
import core.api.*
        ...
        if (killer is Player) {
            ...
            queueScript(killer, 1, QueueStrength.SOFT) {
                face(findNPC(NPCs.JOSSIK_1335)).also {
                    openDialogue(killer, content.region.fremennik.quests.horror.JossikLighthouseDialogue())
                }
