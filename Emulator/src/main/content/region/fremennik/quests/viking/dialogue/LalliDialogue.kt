...
class LalliDialogue(
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            104 ->
                npcl(FaceAnim.OLD_HAPPY, "Me want 1000 coins! You pay or go!").also {
                    stage =
                        if (inInventory(player, Items.COINS_995, 1000)) {
                            105
                        } else {
                            115
                        }
            ...
            106 ->
                when (buttonId) {
                    1 ->
                        playerl(FaceAnim.HAPPY, "Is that all? Here you go!").also {
                    ...
                    2 ->
                        npcl(FaceAnim.OLD_HAPPY, "You no pay, then you go! You no get any golden apples!").also {
                            stage = END_DIALOGUE
                        }
                }
