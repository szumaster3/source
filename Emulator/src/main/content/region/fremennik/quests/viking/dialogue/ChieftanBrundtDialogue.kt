package content.region.fremennik.quests.viking.dialogue
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            9 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Ah, this is because I am the chieftan. I am the one who authorised contact. You will not find many of my tribe so forthcoming with you, as I.",
                ).also {
                    stage++
                }
            ...
            300 -> {
                npc(
                    "Quests, you say outlander? Well, I would not call it a",
            ...
            302 -> {
                options("Yes, I am interested.", "No, I'm not interested.")
                stage++
            }
            ...
            311 -> {
                npc(
                    "and your heart sings for glory, then perhaps you would",
            ...
            313 -> {
                npc(
                    "Well, there are two ways to become a member of our",
                    "clan and call yourself a Fremennik: be born a",
                    "Fremennik, or be voted in by our council of elders.",
                )
                stage++
            }
            ...
            314 -> {
                player(
                    "Well, I think I've missed the first way, but how can I",
                    "get the council of elders to vote to let me join your",
                    "clan?",
                )
                stage++
            }
            ...
            315 -> {
                npc(
                    "Well, that I cannot answer myself. You will need to",
            ...
            316 -> {
                npc(
                    "There are twelve council members around this village;",
                    "you will need to gain a majority vote of at least seven",
                    "councillors in your favor.",
                )
                stage++
            }
            ...
            317 -> {
                npc(
                    "So, what say you? Give me the word and I will tell all",
                    "of my tribe of your intentions, be they yes or nay.",
                )
                stage++
            }

            318 -> {
                options("I want to become a Fremennik!", "I don't want to become a Fremennik.")
                stage++
            }
            ...
            319 ->
                when (buttonId) {
                    1 -> {
                        player(
                            "I think I would enjoy the challenge of becoming an",
                            "honorary Fremennik. Where and how do I start?",
                        )
                        stage =
                            320
                    }
                    ...
                    2 -> {
                        player("That sounds too complicated to me.")
                        stage = 322
                    }
                }
            ...
            321 -> {
                npc(
                    ...
                    "you will be accepted as one of us without question.",
                )
                stage = END_DIALOGUE
            ...
            502 ->
                npcl(
                    FaceAnim.THINKING,
                    "Hmmm. Interesting. Your trials seem to be very different to those I took as a young lad.",
                ).also {
                    stage++
                }
            ...
            503 ->
                npcl(
                    FaceAnim.NEUTRAL,
                    "Well, I am not adverse in principle to giving a slight tax break to our shops.",
                ).also {
                    stage++
                }
            ...
            504 ->
                npcl(
                    FaceAnim.THINKING,
                    "There will of course be a shortfall in the tribe's income, that will need to be made up for elsewhere, however.",
                ).also {
                    stage++
                }
            ...
            505 ->
                npcl(
                    FaceAnim.ASKING,
                    "How about this. For many years Sigli has been the only one in the tribe who knows the locations of the best hunting grounds where game is easiest to catch.",
                ).also {
                    stage++
                }
            ...
            506 ->
                npcl(
                    FaceAnim.ASKING,
                    "If you can persuade him to let the entire tribe know these hunting grounds, then we can increase productivity within the tribe, and any shortfall caused by lowering sales taxes will be covered.",
                ).also {
                    stage++
                }
            ...
            511 ->
                npcl(
                    FaceAnim.ANNOYED,
                    "Sigli the hunter is the only one who knows of such hunting grounds. Go and request his knowledge.",
                ).also {
                    stage =
                        END_DIALOGUE
                }
            ...
            537 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Remember: You need to get at least seven council votes to be accepted as a member of the Fremennik.",
                ).also {
                    stage =
                        550
                }
            ...
            547 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Then let us put the formality aside, and let me personally welcome you into the Fremennik! May you bring us honour!",
                ).also {
                    setAttribute(
                        player,
                        "/save:fremennikname",
            ...
            617 ->
                when (buttonId) {
                    1 ->
                        playerl(
                            FaceAnim.HAPPY,
                            "I'm interested in finding out about that mysterious warrior I fought as part of Thorvalds' combat trial. His name is Koschei I believe.",
                        ).also {
                            stage++
                        }
                    ...
                    2 ->
                        playerl(
                            FaceAnim.HAPPY,
                            "I would like to hear of the lands across the ocean to the North.",
                        ).also {
                            stage =
                                635
                        }
            ...
            618 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Ah... the deathless one... We do not even know if Koschei is his name, when we found him he had no memory,",
                ).also {
                    stage++
                }
            ...
            619 ->
                npcl(
                    FaceAnim.HAPPY,
                    "he was simply repeating that single word. Whatever happened to him must have rattled his soul so hard that his memory ran away from him,",
                ).also {
                    stage++
                }
            ...
            622 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Well, it was a raiding party like any other. We had just struck one of the smaller northern islands to harvest supplies by combat, as our laws allow,",
                ).also {
                    stage++
                }
            ...
            623 ->
                npcl(
                    FaceAnim.HAPPY,
                    "when we saw a figure in the icey waters. As we were at least a 3 week sail from any port, and saw no other ships nearby, he must have been there some time.",
                ).also {
                    stage++
                }
            ...
            625 ->
                npcl(
                    FaceAnim.HAPPY,
                    "He had no clothes or possessions with him, and seemed to have been burnt somehow before he had landed in the water. I cannot help but wonder what burnt him,",
                ).also {
                    stage++
                }
            ...
            626 ->
                npcl(
                    FaceAnim.HAPPY,
                    "for as you may have seen, he is incredibly powerful and resistant to damage by any means I know of! Anyway, we decided to bring him back to Rellekka,",
                ).also {
                    stage++
                }
            ...
            627 ->
                npcl(
                    FaceAnim.HAPPY,
                    "for he did not seem of good health or sound mind, and simply repeated the word Koschei over and over. Yrsa tended to him for many weeks, until one day it was as though a new soul had entered his burnt and broken body.",
                ).also {
                    stage++
                }
            ...
            628 ->
                npcl(
                    FaceAnim.HAPPY,
                    "He suddenly left her house one day, fully healed, and able to speak to us as though nothing had happened to him.",
                ).also {
                    stage++
                }
            ...
            629 ->
                npcl(
                    FaceAnim.HAPPY,
                    "He still had no recollection of how he had come to be in the icey ocean, or of who he was, or where he had come from, but this did not matter to us or him.",
                ).also {
                    stage++
                }
            ...
            630 ->
                npcl(
                    FaceAnim.HAPPY,
                    "He took his trials of adulthood, as you did, and has been a boon to our clan ever since. Someday I fear he may regain his memory, and leave us for his past...",
                ).also {
                    stage++
                }
            ...
            631 ->
                npcl(
                    FaceAnim.HAPPY,
                    "But I will always respect any decision he decides to make should that day ever come upon us. Until then, he is more than welcome to stay here.",
                ).also {
                    stage++
                }
            ...
            635 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Well, I think the best thing for you would be to go to the docks and ask to join one of our longboats on a journey. My affairs are concentrated mostly on Rellekka,",
                ).also {
                    stage++
                }
            ...
            637 ->
                npcl(
                    FaceAnim.HAPPY,
                    "There are a number of small inhabited islands that we have sea routes with. The largest of these is possibly Miscellania,",
                ).also {
                    stage++
                }
            ...
            638 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Although I hear that there has been some recent incident with their monarch, but I don't know the details.",
                ).also {
                    stage++
                }
            ...
            639 ->
                npcl(
                    FaceAnim.HAPPY,
                    "There is also of course the island of the moon clan, who change with the tides. They are our bitterest enemies, and we are currently at war with them.",
                ).also {
                    stage++
                }
            ...
            640 ->
                npcl(
                    FaceAnim.HAPPY,
                    "They are an evil people, equally cursed and blessed by the magic in their blood. Beyond those islands, there is the large frozen wasteland we call Acheron.",
                ).also {
                    stage++
                }
            ...
            641 ->
                npcl(
                    FaceAnim.HAPPY,
                    "It is an inhospitable land, and you will need an agile and sturdy body just to keep alive in its perils.",
                ).also {
                    stage++
                }
            ...
            642 ->
                npcl(
                    FaceAnim.HAPPY,
                    "As I say, my knowledge outside of this town is rather limited, and I know no more than this.",
                ).also {
                    stage++
                }
            ...
            646 ->
                npcl(
                    FaceAnim.HAPPY,
                    "When first man came to these lands all were Fremenniks, and followed our ways. We lived a happy life, and never settled in one place for long.",
                ).also {
                    stage++
                }
            ...
            647 ->
                npcl(
                    FaceAnim.HAPPY,
                    "We travelled by boat along the coastlines, never taking more from the land than could be regrown by the same time in the following year.",
                ).also {
                    stage++
                }
            ...
            648 ->
                npcl(
                    FaceAnim.HAPPY,
                    "However, many moons past, some of our tribesmen were weary of constantly travelling the lands, and decided to build themselves permanent homes.",
                ).also {
                    stage++
                }
            ...
            649 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Unfortunately, the other races that had also migrated here did not like this. They waged war against us at every opportunity.",
                ).also {
                    stage++
                }
            ...
            650 ->
                npcl(
                    FaceAnim.HAPPY,
                    "We were driven mostly to the coastlines, where we could escape by boat when attacked. Remember, at this time we had no real way to defend against constant attack.",
                ).also {
                    stage++
                }
            ...
            651 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Then one day one of our Seers, whose full name has been lost in the telling of this tale, discovered a cave full of strange rocks.",
                ).also {
                    stage++
                }
            ...
            652 ->
                npcl(
                    FaceAnim.HAPPY,
                    "This rock would never be consumed, no matter how much we took, and sparkled at its peak, and broke off in small and regular sized chunks when mined.",
                ).also {
                    stage++
                }
            ...
            653 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Stranger than this, we found that these rocks would become filled with power when taken to certain places across this land! There was a terrible argument in our tribe!",
                ).also {
                    stage++
                }
            ...
            654 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Some said that we should take as many of these rocks as we could, and use them in defending against our enemies' attacks!",
                ).also {
                    stage++
                }
            ...
            655 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Others said that we had found a place that belonged only to the gods, and that should we steal what was not ours we would find only torment and misery.",
                ).also {
                    stage++
                }
            ...
            656 ->
                npcl(
                    FaceAnim.HAPPY,
                    "We voted on this, and decided that it was in the best interests of the tribe to leave these strange rocks where they lay, for the gods can be spiteful and cruel,",
                ).also {
                    stage++
                }
            ...
            657 ->
                npcl(
                    FaceAnim.HAPPY,
                    "especially to those who do not treat them with the respect they desire. Some of our number refused to accept this ruling by our council however.",
                ).also {
                    stage++
                }
            ...
            658 ->
                npcl(
                    FaceAnim.HAPPY,
                    "They began to mine these rocks, and set up transport systems to the various places of power that enchanted them. They even created temples at each of these places!",
                ).also {
                    stage++
                }
            ...
            659 ->
                npcl(
                    FaceAnim.HAPPY,
                    "This was going too far! We had no choice, but to expel them from our tribe forever!",
                ).also {
                    stage++
                }
            ...
            660 ->
                npcl(
                    FaceAnim.HAPPY,
                    "We turned our backs upon them, and let them know they would never be welcome back to our tribes until they had released themselves from the rocks.",
                ).also {
                    stage++
                }
            ...
            665 ->
                npcl(
                    FaceAnim.HAPPY,
                    "Well let me know should you wish to hear our lore and histories. We value them highly.",
                ).also {
                    stage =
                        END_DIALOGUE
                }
            ...
            1201 ->
                npcl(
                    FaceAnim.HALF_THINKING,
                    "I suppose I can grant you one temporarily, provided you meet certain requirements.",
                ).also {
                    stage++
                }
