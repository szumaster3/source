package content.region.fremennik.island.lunar.dialogue
...
class CabinBoyDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            9 -> playerl(FaceAnim.HALF_THINKING, "I think you've been hypnotised. I wonder what happens if I click my fingers?").also {
