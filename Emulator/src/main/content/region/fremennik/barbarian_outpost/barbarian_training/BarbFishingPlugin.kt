package content.region.fremennik.barbarian_outpost.barbarian_training

import content.region.fremennik.barbarian_outpost.barbarian_training.BarbFishSpotManager.Companion.getNewLoc
import content.region.fremennik.barbarian_outpost.barbarian_training.BarbFishSpotManager.Companion.getNewTTL
import content.region.fremennik.barbarian_outpost.barbarian_training.BarbFishSpotManager.Companion.usedLocations
import core.api.*
...
private class BarbFishSpotManager : TickListener, StartupListener {
    var ticks = 0
...
private class BarbFishingSpot(var loc: Location? = null, var ttl: Int) : NPC(NPCs.FISHING_SPOT_1176) {
