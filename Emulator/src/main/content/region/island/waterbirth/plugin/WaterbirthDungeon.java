package content.region.island.waterbirth.plugin;
 ...
 */
@Initializable
public final class WaterbirthDungeon extends MapZone implements Plugin<Object> {
     ...
     */
    public WaterbirthDungeon() {
        super("waterbirth dungeon", true, ZoneRestriction.RANDOM_EVENTS);
    ...
    public boolean interact(Entity e, Node target, Option option) {
        if (e instanceof Player) {
            ...
            switch (target.getId()) {
                case 8966:
                    ClimbActionHandler.climb(player, null, new Location(2523, 3740, 0));
                    return true;
                case 10193:
                    ClimbActionHandler.climb(player, null, new Location(2545, 10143, 0));
                    return true;
                case 10177:
                ...
                case 10230:
                    ...
                    return true;
                case 10229:
                    ClimbActionHandler.climb(player, null, Location.create(1912, 4367, 0));
                    return true;
            }
        }
            ...
            switch (node.getId()) {
                case 8929: {
                    if (inBorders(player, getRegionBorders(10042))) {
                        ...
                        ClimbActionHandler.climb(player, null, Location.create(3056, 9555, 0));
                    }
                    break;
                }
                case 8930: {
                    ClimbActionHandler.climb(player, null, Location.create(2545, 10143, 0));
                    break;
                }
