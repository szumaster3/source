...
enum class CombinationRune(
    ...
    companion object {
        /**
         * Checks which combination runes are eligible for a given rune.
         *
         * @param rune The rune to check eligibility for.
         * @return A list of eligible combination runes that can work with the given rune.
         */
        @JvmStatic
