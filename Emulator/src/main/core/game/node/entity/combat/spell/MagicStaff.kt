...
/**
 * Represents different types of magic staffs.
 *
 * @property runeId The ID of the rune associated with the staff.
 * @property staves A list of item IDs representing the different staff items that can be used with the corresponding rune.
 */
enum class MagicStaff(
    ...
    companion object {
        /**
         * A map storing the magic staff for each rune id.
         */
        ...
        /**
         * Retrieves a [MagicStaff] associated with a given rune id.
         *
