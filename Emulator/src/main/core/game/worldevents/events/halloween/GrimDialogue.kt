...
class GrimDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(
        ...
        when (stage) {
            ...
            6 -> npcl(FaceAnim.NEUTRAL, "It's Hallowe'en, you fool. Everyone's giving out candy.").also { stage++ }
    ...
    private fun handleRewardShop(player: Player, buttonId: Int) {
    ...
    private fun buyStaff(player: Player) {
    ...
    private fun buyRecolor1(player: Player) {
    ...
    private fun buyRecolor2(player: Player) {
