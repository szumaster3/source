...
import content.minigame.vinesweeper.plugin.FlagsHandler.Companion.FARMER_FLAG_LINES
import content.minigame.vinesweeper.plugin.VinesweeperPlugin.Companion.FARMERS
import content.minigame.vinesweeper.plugin.VinesweeperPlugin.Companion.FARMER_CLEAR_RADIUS
import content.minigame.vinesweeper.plugin.VinesweeperPlugin.Companion.HOLES
import content.minigame.vinesweeper.plugin.VinesweeperPlugin.Companion.NUMBERS
import content.minigame.vinesweeper.plugin.VinesweeperPlugin.Companion.RABBITS
import content.minigame.vinesweeper.plugin.VinesweeperPlugin.Companion.SEED_LOCS
import content.minigame.vinesweeper.plugin.VinesweeperPlugin.Companion.populateSeeds
import content.minigame.vinesweeper.plugin.VinesweeperPlugin.Companion.scheduleNPCs
import content.minigame.vinesweeper.plugin.VinesweeperPlugin.Companion.sendPoints
import core.api.*
...
class VinesweeperNPC : AbstractNPC {
    var seedDestinations: ArrayList<VinesweeperPlugin.SeedDestination> = ArrayList()
    ...
    fun farmerClear(dest: VinesweeperPlugin.SeedDestination) {
