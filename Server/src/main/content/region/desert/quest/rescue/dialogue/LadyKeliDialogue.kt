    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
                ...
                2 -> when (buttonId) {
                    ...
                    3 -> player(FaceAnim.HALF_GUILTY, "I have heard rumours that you kill people.").also {
                        stage = 30
                    }
                ...
                12 -> when (buttonId) {
                    ...
                    3 -> player(FaceAnim.HALF_GUILTY, "You must have trained a lot for this work.").also {
                        stage = 25
                    }
                ...
                62 -> npc(FaceAnim.HALF_GUILTY, "You are welcome, run along now, I am very busy.").also {
                    stage = END_DIALOGUE
                }
