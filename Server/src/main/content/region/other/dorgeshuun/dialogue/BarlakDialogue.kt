    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            0 -> npcl(
                ...
                "I'll give you ${getTotalCoinsForCurItem()} gp for the bones you're carrying.",
            ).also {
                stage++
            }
            ...
            1 -> npc(
                ...
                "I'll try to teach you something about Construction as well, but it's highly technical so you won't understand",
                "if you don't already have level 30 Construction.",
            ).also {
                stage++
            }
            ...
            51 -> npcl(
                FaceAnim.OLD_CALM_TALK1,
                "Hmm... I think I might be able to make something out of them.",
            ).also { stage++ }

            52 -> npcl(
                FaceAnim.OLD_CALM_TALK2,
                "I'll give you ${getTotalCoinsForCurItem()} gp for the snail shells you're carrying.",
            ).also {
                stage++
            }
            ...
            55 -> {
                ...
                npcl(
                    FaceAnim.OLD_CALM_TALK1,
                    "Thanks. If you find any more shells like these, please bring them to me!",
                ).also {
                    stage = 99
                }
            }
            ...
            61 -> {
                when (amountInInventory(player, Items.PERFECT_SNAIL_SHELL_10996)) {
                    1 -> npcl(
                        FaceAnim.OLD_CALM_TALK2,
                        "Hmm... I think I might be able to make something out of them, especially that perfect one.",
                    ).also {
                        stage++
                    }
                        ...
                        FaceAnim.OLD_CALM_TALK1,
                        "Hmm... I think I might be able to make something out of them, especially those perfect ones.",
                    ).also {
                        stage = 70
                    }
                }
            ...
            62 -> npcl(
                FaceAnim.OLD_CALM_TALK2,
                "I'll give you ${getTotalCoinsForCurItem()} gp for the snail shell you're carrying, and I'll try to give you some advice on Crafting while I'm at it.",
            ).also {
                stage++
            }
            ...
            65 -> {
                npcl(
                    FaceAnim.OLD_CALM_TALK2,
                    "Thanks! Now, I don't think I could use that for Construction, but maybe I could make something...",
                ).also {
                    stage = 1000
                }
                exchange()
            ...
            70 -> npcl(
                FaceAnim.OLD_CALM_TALK2,
                "I'll give you ${getTotalCoinsForCurItem()} gp for the snail shells you're carrying, and I'll try to give you some advice on Crafting while I'm at it.",
            ).also {
                stage++
            }
            ...
            102 -> npcl(
                FaceAnim.OLD_CALM_TALK2,
                "I'll give you ${getTotalCoinsForCurItem()} gp for the tortoise shells you're carrying.",
            ).also {
                stage++
            }
            ...
            122 -> npcl(
                FaceAnim.OLD_CALM_TALK2,
                "I'll give you ${getTotalCoinsForCurItem()} gp for the perfect shell you're carrying, and I'll try to give you some advice on Crafting while I'm at it.",
            ).also {
                stage++
            }
            ...
            201 -> playerl(
                FaceAnim.FRIENDLY,
                "How do you stand up if you have no bones? Shouldn't you collapse into a gelatinous blob?",
            ).also {
                stage++
            }
            ...
            220 -> npcl(
                FaceAnim.OLD_LAUGH1,
                "To stand up properly. Otherwise I'd collapse into a gelatinous blob! Ha, ha, ha, ha, ha! No, seriously, I need bones to use as a Construction material.",
            ).also {
                stage++
            }
            ...
            221 -> npcl(
                FaceAnim.OLD_CALM_TALK1,
                "We always need big bones to prop up the mine shafts and to make other temporary structures.",
            ).also {
                stage = 152
            }
            ...
            240 -> npcl(
                FaceAnim.OLD_CALM_TALK2,
                "Well, I've had a few people bring me some interesting giant shells. They say they came from giant snails and giant tortoises. Of course, like the bones, some shells are better than others.",
            ).also {
                stage++
            }
            ...
            241 -> npcl(
                FaceAnim.OLD_CALM_TALK1,
                "I'll give you 250gp for ordinary shells, but what I really need are perfect shells.",
            ).also {
                stage++
            }
            ...
            242 -> npcl(
                FaceAnim.OLD_CALM_TALK2,
                "I'll pay double for them and give you a few tips about Crafting too.",
            ).also {
                stage = 152
            }
            ...
            260 -> npcl(
                FaceAnim.OLD_CALM_TALK1,
                "Enormous bones, as big as you can get. Not just any big bones will do. Sometimes you might find a particularly long, straight bone. That's the kind of thing I need; I'll give you 1,000gp for one of them.",
            ).also {
                stage++
            }
            ...
            261 -> npcl(
                FaceAnim.OLD_CALM_TALK2,
                "Occasionally, you might find a long curved bone - these are especially valuable - I'll give you 2,000gp for them. I'll also teach you a bit about how we use the bones in Construction, if you like.",
            ).also {
                stage = 152
            }

            280 -> npc(FaceAnim.OLD_CALM_TALK2, "Goodbye.").also { stage = 99 }
            999 -> sendDialogue("Barlak gives you a short lecture and you learn more about Construction.").also {
                stage = 99
            }

            1000 -> sendDialogue("Barlak gives you a short lecture and you learn more about Crafting.").also {
                stage = 99
            }

            1001 -> sendDialogue("Barlak gives you a short lecture and you learn more about Crafting.").also {
                stage = 130
            }
