...
public class TheKnightsSword extends Quest {
    ...
    public void drawJournal(Player player, int stage) {
        ...
        switch (stage) {
            ...
            case 60:
                ...
                if (player.getInventory().contains(Items.BLURITE_SWORD_667, 1) || player.getEquipment().contains(Items.BLURITE_SWORD_667, 1) || player.getBank().contains(Items.BLURITE_SWORD_667, 1)) {
    ...
    public void finish(Player player) {
        super.finish(player);
        player.getPacketDispatch().sendString("1 Quest Point", Components.QUEST_COMPLETE_SCROLL_277, 8 + 2);
        player.getPacketDispatch().sendString("12,725 Smithing XP", Components.QUEST_COMPLETE_SCROLL_277, 9 + 2);
        player.getPacketDispatch().sendString("You have completed the Knight's Sword Quest!", Components.QUEST_COMPLETE_SCROLL_277, 2 + 2);
        player.getPacketDispatch().sendItemZoomOnInterface(Items.BLURITE_SWORD_667, 230, Components.QUEST_COMPLETE_SCROLL_277, 3 + 2);
