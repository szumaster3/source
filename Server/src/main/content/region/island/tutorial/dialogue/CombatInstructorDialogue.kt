    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (getAttribute(player, TutorialStage.TUTORIAL_STAGE, 0)) {
            ...
            in 55..100 -> when (stage) {
                ...
                2 -> npcl(
                    FaceAnim.FRIENDLY, "Certainly. You have three main combat stats: Strength, Defence and Attack."
                ).also { stage++ }
                ...
                10 -> npcl(
                    FaceAnim.FRIENDLY, "Now, was there something else you wanted to hear about again?"
                ).also { stage = 0 }
                ...
                25 -> npcl(
                    FaceAnim.FRIENDLY,
                    "It is also the only place in the land of ${GameWorld.settings!!.name} where players are able to attack each other at will, and as such is the haunt of many Player Killers, or PKers if you will."
                ).also { stage++ }

                26 -> npcl(
                    FaceAnim.FRIENDLY,
                    "There are a few things different in the Wilderness in comparison to the rest of the lands of ${GameWorld.settings!!.name}. Firstly, as I just mentioned, you can and will be attacked by other players."
                ).also { stage++ }
