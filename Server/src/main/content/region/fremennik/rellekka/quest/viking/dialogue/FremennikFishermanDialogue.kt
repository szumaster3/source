...
class FremennikFishermanDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            5 -> npcl(FaceAnim.HAPPY, "Indeed it is, Outlander. The only reason I sit out here in the cold all day long is so I don't have to pay his outrageous prices.").also { stage++ }
            ...
            15 -> npcl(FaceAnim.HAPPY, "Great work Outlander! With this, I can finally catch enough fish to make an honest living from it! Here, have the stupid fish.").also {
            ...
            200 -> npcl(FaceAnim.ANNOYED, "Don't talk to me Outlander. Anything you have to say to me, you can say to the Chieftain. Goodbye.").also { stage = END_DIALOGUE }
            1000 -> end()
        }
    }
}
