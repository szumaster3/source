...
class SigmundDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            7 -> npcl(FaceAnim.NEUTRAL, "Calm yourself Outlander. It is but a small task really... I simply require a flower.").also { stage++ }
            ...
            15 -> npcl(FaceAnim.THINKING, "Ah, well Outlander, if I knew where to start looking I would simply do it myself!").also { stage++ }
            ...
            25 -> npcl(FaceAnim.ASKING, "So... how goes it Outlander? Did you manage to obtain my flower for me yet? Or do you lack the necessary merchanting skills?").also { stage++ }
            ...
            40 -> npcl(FaceAnim.HAPPY, "Hello again Outlander! I am amazed once more at your apparent skill at merchanting!").also { stage++ }
            41 -> playerl(FaceAnim.HAPPY, "So I can count on your vote at the council of elders?").also { stage++ }
            42 -> npcl(FaceAnim.HAPPY, "Absolutely, Outlander. Your merchanting skills will be a real boon to the Fremennik.").also { stage = 1000 }
            ...
            60 -> npcl(FaceAnim.HAPPY, "Hello Outlander. By the laws of our tribe, I am afraid I may not speak to you without the express permission of the chieftain.").also { stage++ }
