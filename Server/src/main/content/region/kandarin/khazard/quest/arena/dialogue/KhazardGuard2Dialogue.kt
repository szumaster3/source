...
class KhazardGuard2Dialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        if (isQuestComplete(player, Quests.FIGHT_ARENA)) {
            ...
            if (npc.id == NPCs.KHAZARD_GUARD_253) playerl(FaceAnim.FRIENDLY, "Hi.").also { stage = 7 }
        }
        return true
    }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            4 -> npcl(FaceAnim.FRIENDLY, "Khazard died two hundred years ago. However his dark spirit remains in the form of the undead maniac General Khazard. Remember he is your master, always watching.").also { stage++ }
            ...
            7 -> npcl(FaceAnim.ANNOYED, "This area is restricted. Leave now! OUT! And don't come back.").also { stage++ }
    ...
    override fun getIds(): IntArray = intArrayOf(NPCs.KHAZARD_GUARD_254)
}
