...
class KingLathasDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        when {
            ...
            progress == 3 && inInventory(player, Items.LETTER_6756) -> npcl(FaceAnim.FRIENDLY, "What would you like to talk about?").also { stage = 1 }
            inInventory(player, Items.LETTER_6757) -> npcl(FaceAnim.FRIENDLY, "Have you taken that letter to Jorral yet?").also { stage = 11 }
            !inInventory(player, Items.LETTER_6757) -> playerl(FaceAnim.FRIENDLY, "Excuse me sire, but I seem to have lost that letter you gave me.").also { stage = 14 }
            else -> {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            3 -> playerl(FaceAnim.FRIENDLY, "Excuse me. I have been asked to hand you this from Jorral at the outpost.").also { stage++ }
            ...
            6 -> npcl(FaceAnim.FRIENDLY, "I had no idea that place had any value at all! All this about my great-grandfather and Jorral's plans to make it into a museum makes for a convincing case.").also { stage++ }
            7 -> playerl(FaceAnim.FRIENDLY, "I am sure he only wants what is best.").also { stage++ }
            8 -> npcl(FaceAnim.FRIENDLY, "Very well, I will comply with his request. Take this letter back to him with my kind regards.").also { stage++ }
