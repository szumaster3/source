    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            48 -> when (buttonId) {
                ...
                2 -> playerl(FaceAnim.HALF_ASKING, "Can you tell me where I would find Jimmy Dazzler?").also {
                    stage = 50
                }

                3 -> playerl(FaceAnim.HALF_ASKING, "Can you tell me where I could find Smokin Joe?").also {
                    stage = 55
                }

                4 -> playerl(FaceAnim.HALF_ASKING, "Can you tell me where I would find 'The Face'?").also {
                    stage = 56
                }
            ...
            49 -> npcl(FaceAnim.FRIENDLY, "Oh the girls? You'll find them down in the sewers here in Varrock.").also {
                stage = END_DIALOGUE
            }
            ...
            54 -> sendDialogue(player, "Jack shoots you a look that could rout a regiment of black knights.").also {
                stage = END_DIALOGUE
            }

            55 -> npcl(FaceAnim.FRIENDLY, "He should be in Keldagrim, the city of the dwarves.").also {
                stage = END_DIALOGUE
            }
            ...
            61 -> when (buttonId) {
                ...
                2 -> playerl(FaceAnim.HALF_ASKING, "What benefits does my cat get from training in the pits?").also {
                    stage = 89
                }
            }
            ...
            82 -> when (buttonId) {
                1 -> playerl(FaceAnim.HALF_ASKING, "I think I would adopt a very aggressive strategy.").also {
                    stage = 83
                }
            ...
            93 -> if (!hasRequirement(player, Quests.RATCATCHERS)) {
