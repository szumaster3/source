...
class KuraskHeadDialogue : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            3 -> playerl(FaceAnim.FRIENDLY, "How are you going to do that? You're just a head on a wall!").also { stage++ }
            ...
            19 -> playerl(FaceAnim.FRIENDLY, "Yeah! I could kill you again in my sleep! I think I might go off and kill some other kurask!").also { stage++ }
            20 -> npcl(FaceAnim.CHILD_FRIENDLY, "Uuuurrrrh! Hate you!").also { stage++ }
            21 -> playerl(FaceAnim.FRIENDLY, "What are you going to do about it? Eh? I totally owned you!").also { stage++ }
            ...
            32 -> npcl(FaceAnim.CHILD_FRIENDLY, "Smash! Destroy! Crunch break tear destroy splunch! Hurt wound kill hit punch stab slash kill!").also { stage++ }
            ...
            38 -> npcl(FaceAnim.CHILD_FRIENDLY, "Skitter skitter through head noise in ears behind eyes.").also { stage++ }
            ...
            42 -> npcl(FaceAnim.CHILD_FRIENDLY, "Hate lack of feet! Stomp lack of feet! Kill crush destroy smash!").also { stage++ }
            43 -> playerl(FaceAnim.FRIENDLY, "That makes no sense! You can't destroy the absence of something!").also { stage++ }
            44 -> npcl(FaceAnim.CHILD_FRIENDLY, "Hate requirement to make sense! Smash it kill it destroy kill kill!").also { stage++ }
            45 -> playerl(FaceAnim.FRIENDLY, "You can't physically destroy an abstract concept! It's impossible!").also { stage++ }
            46 -> npcl(FaceAnim.CHILD_FRIENDLY, "Hate abstract concepts! Hate impossible! Kill kill kill destroy smash!").also { stage++ }
            47 -> playerl(FaceAnim.FRIENDLY, "This is getting both surreal and repetitive.").also { stage = END_DIALOGUE }
        }
    }
}
