...
class TribalMaskPlugin : InteractionListener {
    ...
    private val nailIDs = intArrayOf(Items.BRONZE_NAILS_4819, Items.IRON_NAILS_4820, Items.STEEL_NAILS_1539, Items.BLACK_NAILS_4821, Items.MITHRIL_NAILS_4822, Items.ADAMANTITE_NAILS_4823, Items.RUNE_NAILS_4824)
